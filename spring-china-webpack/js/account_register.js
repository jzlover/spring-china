...
var account_register=function(){
	//表单是否有错
	var has_error = false;
    var hiddenWxId=null;
    var hiddenWxAvatar=null;
	$(function () {
        var hiddenWxAvatar = $('#hidden-wxAvatarUrl').val();
        var hiddenWxId = $('#hidden-wxId').val();
	    ...
	    $('#userName').blur(function () {
	        ...
	        CommonAjax.postJSON('/account-ajax/check-userName',JSON.stringify(username),function(data){
	    ...
	    $('#nickName').blur(function () {
	        ...
	        CommonAjax.postJSON('/account-ajax/check-nickName',JSON.stringify(nickname),function(res){
	    ...
	    $('#btn-reg').click(function(){
	        ...
	        var user={
	            ...
	            password:password,
	            nickName:nickname,
                wxAvatarUrl:hiddenWxAvatar,
				wxId:hiddenWxId
	        };
	        $(me).attr('disabled','disabled');
	        var loading = layer.load();

	        CommonAjax.postJSON('/account-ajax/register',JSON.stringify(user),function(res){
	            layer.close(loading);
	            Form.defaultCallback(res,{
	                success:function(){
	                    layer.msg('注册成功！',{
